...
urlpatterns = [
    ...
    path("api/cacarolas/state/", views.api_cacarolas_state, name="api_cacarolas_state"),
    path("api/cacarolas/maquinas/add/", views.api_cacarolas_add_maquina, name="api_cacarolas_add_maquina"),
    path("api/cacarolas/maquinas/update/", views.api_cacarolas_update_maquina, name="api_cacarolas_update_maquina"),
    path("api/cacarolas/maquinas/delete/", views.api_cacarolas_delete_maquina, name="api_cacarolas_delete_maquina"),
    path("api/cacarolas/produtos/upsert/", views.api_cacarolas_upsert_produtos, name="api_cacarolas_upsert_produtos"),
    path("api/cacarolas/registros/upsert/", views.api_cacarolas_upsert_registro, name="api_cacarolas_upsert_registro"),
    path("api/cacarolas/registros/delete/", views.api_cacarolas_delete_registro, name="api_cacarolas_delete_registro"),
